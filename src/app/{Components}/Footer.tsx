  ...
  return (
    <footer className='w-full h-1/4 bg-black text-white mt-5'>
        <div className="flex flex-1 justify-between items-center">
            ...
            <div className='w-1/2 md:w-3/4 flex flex-col justify-center items-center md:justify-start md:items-start gap-2 mt-2'>
                <h3 className="text-xl font-bold mt-2">Page Links</h3>
                <div>
                    <ul className='flex flex-col md:flex-row justify-start items-start gap-5 text-lg flex-wrap'>
